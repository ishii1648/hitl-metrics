...
[ADR-017](../../docs/archive/adr/017-automated-implementation-session-dispatch.md) で導入した `/dispatch` skill（本リポジトリ専用の `.claude/skills/dispatch/`）を、user skill（`~/.claude/skills/dispatch/`）として汎用化し、本リポジトリ内の skill 定義は削除した。
