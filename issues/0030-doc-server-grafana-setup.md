...
依存: [0028](0028-feat-server-push-client.md) と [0029](0029-feat-server-ingest.md)（実装と manifest が無いと文書化が成立しない）、[0031](0031-feat-server-image-ghcr-publish.md)（image が ghcr に上がっていないと k8s manifest が pull できない）
