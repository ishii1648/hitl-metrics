...
claudedog の設計判断を記録する ADR（Architecture Decision Record）の一覧。
...
| 013 | 部分廃止 | 複合 | claudedog をトップレベルディレクトリに隔離し開発プロセスを分離する | [ADR-013](013-claude-stats-directory-isolation.md) |
...
| 018 | 採用済み | metrics / dashboard | メトリクス体系の再設計 — merged PR スコープとタスク種別分類 | [ADR-018](018-metrics-redesign-merged-pr-scope.md) |
