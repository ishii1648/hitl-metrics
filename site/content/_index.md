...
このサイトはツールの **how it works**（観察軸・hook 構成・データフロー）に絞った解説 docs を提供します。CLI 仕様 / 設計判断 / セットアップ手順といった reference 系ドキュメントは引き続き [GitHub repo の `docs/`](https://github.com/ishii1648/agent-telemetry/tree/main/docs) を正とします。
